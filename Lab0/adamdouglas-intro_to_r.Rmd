...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
    ...
    No, Arbuthnot's records were baptism records and not birth records and thus a different scale.
...
```{r}
plot(present$year, present$boys / present$girls, type = "l", xlab="Year", ylab="Boy-to-Girl Ratio", main="U.S. Birth Rates by Sex")
```

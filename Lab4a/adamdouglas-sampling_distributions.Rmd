...
**This population distribution is centered around 1,500 and is considerably right-skewed.**
...
**Like the population, the sample is also right-skewed. The distribution is centered around 1450 - 1500.**
...
**This time, the sample mean is above the population mean (and the first sample's mean).**
...
**There are 5000 elements in `sample_means50`. The sampling distribution is close to normal and centered near 1500. If we sampled 50000 sample means, I would expect the distribution to look even closer to normal and the mean of those samples to approach the population mean.**
...
**The center stays the same, but the variability/spread is less as the sample size increases.**
...
**My point estimate for the population mean is `r format(mean_50, scientific=FALSE, big.mark=",")`.**
...
**The sampling distribution of `price` is nearly normal with a mean of `r format(mean_sample_means, scientific=FALSE, big.mark=",")`. The population mean `price` is `r format(pop_mean, scientific=FALSE, big.mark=",")`.**
...
**This distribution is also nearly normal, similar to the last one. Based on this distribution I would guess the population mean to be `r format(mean_sample_means, scientific=FALSE, big.mark=",")`.**
...
**The larger sample size (150 vs. 50) has a smaller spread. A smaller spread means that we would be more often close to the true population mean, thus the mean of a larger sample size has less variability and is a better estimator.**
